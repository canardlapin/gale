...
|---|---|---|
| `Eigen.eigSymmetric(a, sel, vectors)` | gains `(using b: SpectralBackend)`; consults `b.denseSymmetricEigen` when `DenseSymmetricEigen`-capable, else the pure call | pure kernel — identical |
